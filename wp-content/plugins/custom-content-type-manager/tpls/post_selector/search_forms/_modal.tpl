...
<p>[+description+]<a href="http://code.google.com/p/wordpress-custom-content-type-manager/wiki/SearchParameters"><img src="[+cctm_url+]/images/question-mark.gif" width="16" height="16" /></a></p>
